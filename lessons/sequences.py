"""Examples of the tuple and range sequence."""
...
# Tuples, unlikes lists, are imutable
...
# Once we're aliased a type, we can create variables of that type
...
zero_to_nine: range = range(o, 10, 1)
